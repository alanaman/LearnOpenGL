...
int main()
{
    ...
    Shader shader("res/shaders/MultiLightsShadow.shader");
    Shader simpleDepthShader("res/shaders/DepthMap.shader");
    Shader debugDepthQuad("res/shaders/TextureRenderer.shader");
    ...
    unsigned int lightVAO;
        ...
        glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 8 * sizeof(float), (void*)0);
        glEnableVertexAttribArray(0);
    unsigned int diffuse_texture = loadTexture("res/images/containerDiffuse.png");
    unsigned int specular_texture = loadTexture("res/images/containerDiffuse.png");
    ...
    shader.setVec3("dirLight.direction", 2.0f, -4.0f, 1.0f);
